...
public class RemoteWebSocketConfig implements WebSocketConfigurer {
    ...
    public RemoteWebSocketConfig(RemoteAgentService agentService, RemoteTerminalBroker broker, RemoteTerminalService terminalService) {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
        registry.addHandler(new RemoteAgentWebSocketHandler(agentService, broker, terminalService), "/api/remote/ws/agent")
                .setAllowedOrigins("*");
