    ...
    <section class="share-card">
      ...
      <template v-else-if="ticket">
        <section class="problem">
          <div class="meta"><b>{{ticket.category||'技术问题'}}</b><span>{{time(ticket.create_time)}}</span></div>
          <h2>问题描述</h2>
        ...
        <footer>
          此页面仅展示分享人授权的问题内容和客户原始附件，不提供工单处理、账号信息或其他工单访问权限。
        </footer>
      </template>
    </section>
  </main>
